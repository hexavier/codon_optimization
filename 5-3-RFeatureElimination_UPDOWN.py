...
#%% #ROC curve
    ...
    # show the plot
    plt.show()
    fig.savefig(str("plots/all_RFE_RCU_to_UPDOWNproteins/RFE_%s.pdf" % t), bbox_inches='tight')
...
# show the plot
plt.show()
fig.savefig("plots/all_RFE_RCU_to_UPDOWNproteins/RFE.pdf", bbox_inches='tight')
    
#%% Save
RFEmeans.to_csv("results/mean_all_RFE_RCU_to_UPDOWNproteins.csv")
RFEstd.to_csv("results/std_all_RFE_RCU_to_UPDOWNproteins.csv")
