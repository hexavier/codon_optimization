...
TSproteins = pd.read_csv("results/TSall_mRNA-UP-FCavg2-FCglob1.tsv", sep="\t", index_col=0)
...
#%% #Creating a bar plot of feature importances
    ...
    plt.show()
    fig.savefig(str("plots/mRNA-all_RandomForest_codusnorm_to_UPDOWNproteins/features_proteins_%s.pdf" % t), bbox_inches='tight')
#%% #ROC curve
    fig = plt.figure()
    ...
    # show the plot
    plt.show()
    fig.savefig(str("plots/mRNA-all_RandomForest_codusnorm_to_UPDOWNproteins/roc_proteins_%s.pdf" % t), bbox_inches='tight')
...
#%% #Precision-Recall Curve
    ...
    # show the plot
    plt.show()
    fig.savefig(str("plots/mRNA-all_RandomForest_codusnorm_to_UPDOWNproteins/prec-recall_proteins_%s.pdf" % t), bbox_inches='tight')

#%% Save
RFmeans.to_csv("results/mean_mRNA-all_randomforest_codusnorm_to_UPDOWNproteins.csv")
RFstd.to_csv("results/std_mRNA-all_randomforest_codusnorm_to_UPDOWNproteins.csv")
