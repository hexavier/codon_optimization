...
for t in tissues:
    ...
    codusnorm = codus.loc[genes,codons].apply(relative_codons, axis=1)
...
#%% #Creating a bar plot of feature importances
    ...
    plt.show()
    fig.savefig(str("plots/all_RandomForest_RCU_to_UPDOWNproteins/features_proteins_%s.pdf" % t), bbox_inches='tight')
#%% #ROC curve
    fig = plt.figure()
    ...
    # show the plot
    plt.show()
    fig.savefig(str("plots/all_RandomForest_RCU_to_UPDOWNproteins/roc_proteins_%s.pdf" % t), bbox_inches='tight')
...
#%% #Precision-Recall Curve
    ...
    # show the plot
    plt.show()
    fig.savefig(str("plots/all_RandomForest_RCU_to_UPDOWNproteins/prec-recall_proteins_%s.pdf" % t), bbox_inches='tight')

#%% Save
RFmeans.to_csv("results/mean_all_randomforest_RCU_to_UPDOWNproteins.csv")
RFstd.to_csv("results/std_all_randomforest_RCU_to_UPDOWNproteins.csv")
